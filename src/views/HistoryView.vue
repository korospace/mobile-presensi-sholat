        ...
        class="w-full flex-1 flex flex-col overflow-hidden">
          ...
          <header
            class="relative z-20 w-full h-64 flex justify-center overflow-visible">
              ...
              <!-- status description -->
              <div
                class="absolute -bottom-14 w-full flex flex-col items-center p-4 text-sm text-neutral-900/80 bg-neutral-200 rounded-t-3xl">
                              ...
                              class="flex-1 text-center text-md capitalize text-slate-600/90 font-bold">
                                ...
                                <div
                                  :class="{
                                    ...
                                    'text-green-300': sholat.status == 'berjamaah',
                                    'text-yellow-300': sholat.status == 'munfarid',
                                    'text-red-500': sholat.status == 'tidak sholat',
                                  }" 
